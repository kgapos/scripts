...
First of all, thank you for considering to contribute to Scripts! Your help is invaluable to improve the project and make it more useful for the community. This document will guide you through the contribution process and make it easier for you to get started.

## Table of Contents

- [CONTRIBUTING to Scripts](#contributing-to-scripts)
...
If you find a bug, please create a new issue in the [issue tracker](https://github.com/kgapos/scripts/issues). When submitting a bug report, please include:
...
If you have an idea for a new feature or improvement, please create a new issue in the [issue tracker](https://github.com/kgapos/scripts/issues). When suggesting an enhancement, please include:
...
There are no written style guidelines for this project yet. Please follow the conventions used in the existing code.
...
Once again, thank you for your interest in contributing to Scripts! Your support and collaboration are crucial to the success and growth of this project. If you have any questions or need additional guidance, please don't hesitate to reach out to the maintainers.
